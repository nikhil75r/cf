...
print('----------')
cloud_controller_url = 'https://api.cloud.pcftest.com'
#loud_controller_url = raw_input('cloud controller url: ').strip()
sreddy1 = raw_input('username ').strip()
password = getpass('wav9Elbc$xG3: ').strip()
